...
disp('The only input needed is a distance matrix file')     %% 输入距离矩阵即可，如果只有原始数据，需要求一下距离矩阵
disp('The format of this file should be: ')
disp('Column 1: id of element i')
disp('Column 2: id of element j')
disp('Column 3: dist(i,j)')
%% 从文件中读取数据，注意文件路径两旁加单引号
...
%% 确定 dc，按照作者的意思，选取的截断距离dc应当能够使得样本集中所有点的邻居点个数和的平均值占到点总数的1%至2%会比较好
percent=2.0;
